...
from app.services.learning_status import load_learning_status
...
async def fallback_answer_and_learn(
    ...
    """
    try:
        from app.services.knowledge_store import save_knowledge
...
def manual_learn():
    from app.services.learning_engine import learn_topics_for_run
